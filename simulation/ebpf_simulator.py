"""
eBPF/bpfd simulator - deterministic.
"""
import numpy as np
import pandas as pd
import random
...
class eBPFSimulator:
    def __init__(self, num_nodes: int = 2, gpus_per_node: int = 4,
        ...
        self.metrics = {
            ...
            'avg_latency_ns': 0, 'p95_latency_ns': 0, 'p99_latency_ns': 0,
        }
    ...
    def generate_event(self, event_type: str, rank_src: int,
        ...
        ev = BPFEvent(
            ...
            event_type=event_type, rank_src=rank_src, rank_dst=rank_dst,
    ...
    def generate_nccl_communication_events(self, collective_type: str,
                                            num_messages: int = 100,
                                            size_range_mb: Tuple[float, float] = (10, 500)) -> List[BPFEvent]:
        events = []
